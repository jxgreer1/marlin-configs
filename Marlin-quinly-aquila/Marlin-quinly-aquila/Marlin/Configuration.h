...
#define STRING_CONFIG_H_AUTHOR "MachineCreators" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Aquila Quinly"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    // Volcano
    // #define DEFAULT_Kp_LIST {  29.90,  29.90 }
    // #define DEFAULT_Ki_LIST {   2.33,   2.33 }
    // #define DEFAULT_Kd_LIST {  95.88,  95.88 }
  #else
    // Ender 3 v2
 ...
 *     O-- FRONT --+
 */
// #define NOZZLE_TO_PROBE_OFFSET {  -39.4, 5, -0.5 } // Hero-Me + Volcano
#define NOZZLE_TO_PROBE_OFFSET {  -45.5, -8, -2.2 } // Aquila w/Ender 3 Mount
